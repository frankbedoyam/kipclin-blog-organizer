...
const BlogOrganizer = () => {
  ...
  { id: 13, title: "Productos de limpieza ecológicos, di NO al plástico", author: "Natalia Villa", date: "2019-02-18", hits: 7060, category: "Medio ambiente" },
  { id: 14, title: "Tratamiento de choque para piscinas", author: "Natalia Villa", date: "2019-03-06", hits: 15655, category: "Piscinas" },
  { id: 15, title: "Cómo limpiar el agua verde de tu piscina: Guía completa", author: "Natalia Villa", date: "2019-03-06", hits: 292211, category: "Piscinas" },
  { id: 16, title: "Cómo entrar al baño de la oficina y pasar desapercibido", author: "Natalia Villa", date: "2019-03-06", hits: 6052, category: "Salud y bienestar" },
  { id: 17, title: "Detergente en polvo o líquido ¿Cuál es el tuyo?", author: "Natalia Villa", date: "2019-03-18", hits: 10224, category: "Productos" },
  { id: 18, title: "¿Qué es y para qué sirve el amonio cuaternario?", author: "Natalia Villa", date: "2019-03-18", hits: 511352, category: "Productos" },
  { id: 19, title: "Escoger un detergente para la ropa, lo que debes saber", author: "Natalia Villa", date: "2019-03-18", hits: 3221, category: "Productos" },
  { id: 20, title: "Destino Refill", author: "Super User", date: "2019-03-18", hits: 70334, category: "KipClin" },
  { id: 21, title: "Destino Piscinas", author: "Super User", date: "2019-03-18", hits: 20610, category: "Piscinas" },
  { id: 22, title: "Destino PetitPoo", author: "Super User", date: "2019-03-18", hits: 3268, category: "Productos" },
  { id: 23, title: "Destino Limpiapisos", author: "Super User", date: "2019-03-19", hits: 14433, category: "Productos" },
  { id: 24, title: "Destino Lavaloza", author: "Super User", date: "2019-03-19", hits: 3177, category: "Productos" },
  { id: 25, title: "Destino Detergente", author: "Super User", date: "2019-03-19", hits: 4870, category: "Productos" },
  { id: 26, title: "Destino Suavizante", author: "Super User", date: "2019-03-19", hits: 847, category: "Productos" },
  { id: 27, title: "Destino Desinfecta", author: "Super User", date: "2019-03-19", hits: 1024, category: "Productos" },
  { id: 28, title: "Conoce las 6 cosas que debes desinfectar ahora mismo y cómo hacerlo", author: "Natalia Villa", date: "2019-04-17", hits: 3326, category: "Salud y bienestar" },
  { id: 29, title: "Limpiar y desinfectar ¡esa es la cuestión!", author: "Natalia Villa", date: "2019-04-26", hits: 3087, category: "Productos" },
  { id: 30, title: "La importancia del tapabocas para manipular alimentos", author: "Natalia Villa", date: "2019-04-26", hits: 34334, category: "Salud y bienestar" },
  { id: 31, title: "Aliados en productos de aseo y limpieza", author: "Natalia Villa", date: "2019-04-26", hits: 2142, category: "Productos" },
  { id: 32, title: "Hongos y bacterias, que no los veas no significa que no estén ahí", author: "Natalia Villa", date: "2019-04-26", hits: 2053, category: "Salud y bienestar" },
  { id: 33, title: "10 tips de limpieza y desinfección para gimnasios impecables", author: "Natalia Villa", date: "2019-06-14", hits: 7521, category: "Salud y bienestar" },
  { id: 34, title: "Recomendaciones y cuidados al usar desinfectantes", author: "Natalia Villa", date: "2019-06-14", hits: 10121, category: "Productos" },
  { id: 35, title: "¿Cómo nivelar el pH de la piscina?", author: "Natalia Villa", date: "2019-06-26", hits: 200644, category: "Piscinas" },
  { id: 36, title: "¿Cada cuánto se debe hacer tratamiento de choque a la piscina?", author: "Natalia Villa", date: "2019-07-03", hits: 16736, category: "Piscinas" },
  { id: 37, title: "Guía completa para aclarar el agua de tu piscina rápidamente", author: "Natalia Villa", date: "2019-07-10", hits: 587738, category: "Piscinas" },
  { id: 38, title: "¿Cómo calcular cuántos metros cúbicos tiene mi piscina?", author: "Natalia Villa", date: "2019-07-18", hits: 587954, category: "Piscinas" },
  { id: 39, title: "Sistema de REfill KipClin, súmate al cambio", author: "Natalia Villa", date: "2019-08-14", hits: 2927, category: "KipClin" },
  { id: 40, title: "Con nuestro sistema de REfill le hemos ahorrado al planeta 1.596 kilos de plástico en 5 meses", author: "Natalia Villa", date: "2019-08-20", hits: 3223, category: "Medio ambiente" },
  { id: 41, title: "Compra en línea, compra segura, compra confiable, ¡compra KipClin!", author: "Natalia Villa", date: "2019-08-27", hits: 1827, category: "KipClin" },
  { id: 42, title: "¿Cómo funciona el panel de administración inteligente KipClin?", author: "Natalia Villa", date: "2019-08-31", hits: 1715, category: "KipClin" },
  { id: 43, title: "El baño ideal para tu negocio", author: "Natalia Villa", date: "2019-09-03", hits: 4173, category: "Salud y bienestar" },
  { id: 44, title: "Cómo hacer rendir el papel higiénico y disminuir el desperdicio", author: "Natalia Villa", date: "2019-09-03", hits: 5127, category: "Salud y bienestar" },
  { id: 45, title: "Escoge el dispensador de papel higiénico adecuado", author: "Natalia Villa", date: "2019-09-03", hits: 2429, category: "Salud y bienestar" },
  { id: 46, title: "El manejo de residuos con contenedores de colores", author: "Natalia Villa", date: "2019-09-23", hits: 13787, category: "Medio ambiente" },
  { id: 47, title: "La importancia de las tres Rs: Reducir, Reutilizar y Reciclar", author: "Natalia Villa", date: "2019-09-23", hits: 4541, category: "Medio ambiente" },
  { id: 48, title: "Cómo pasar el control de sanidad en tu restaurante", author: "Natalia Villa", date: "2019-10-21", hits: 4712, category: "Bioseguridad" },
  { id: 49, title: "Una piscina cristalina no siempre está limpia", author: "Natalia Villa", date: "2019-11-11", hits: 3282, category: "Piscinas" },
  { id: 50, title: "Normas de seguridad en piscinas, Ley 1209 de 2008", author: "Natalia Villa", date: "2019-11-15", hits: 13652, category: "Piscinas" },
  { id: 51, title: "Preguntas y respuestas sobre 7 problemas frecuentes en piscinas", author: "Natalia Villa", date: "2019-11-16", hits: 6605, category: "Piscinas" },
  { id: 52, title: "¿Qué es la contaminación cruzada?", author: "Natalia Villa", date: "2019-12-03", hits: 16464, category: "Bioseguridad" },
  { id: 53, title: "Cómo evitar la contaminación cruzada", author: "Natalia Villa", date: "2019-12-10", hits: 3293, category: "Salud y bienestar" },
  { id: 54, title: "Códigos de color para evitar la contaminación cruzada", author: "Natalia Villa", date: "2019-12-17", hits: 14444, category: "Salud y bienestar" },
  { id: 55, title: "¿Qué es la contaminación cruzada hospitalaria?", author: "Natalia Villa", date: "2019-12-24", hits: 31490, category: "Bioseguridad" },
  { id: 56, title: "Identifica establecimientos sanos y seguros mediante estrategia de semaforización sanitaria", author: "Natalia Villa", date: "2020-01-07", hits: 5292, category: "Salud y bienestar" },
  { id: 57, title: "¿Tienes o planeas abrir una peluquería o centro de estética? ¡Atención a la normativa!", author: "Natalia Villa", date: "2020-01-14", hits: 26437, category: "Bioseguridad" },
  { id: 58, title: "Manual de bioseguridad para peluquerías y centros cosméticos", author: "Natalia Villa", date: "2020-01-21", hits: 55420, category: "Bioseguridad" },
  { id: 59, title: "Métodos de desinfección y esterilización para pasar el control de sanidad", author: "Natalia Villa", date: "2020-01-28", hits: 10645, category: "Bioseguridad" },
  { id: 60, title: "Lo que debes saber de los desinfectantes o sanitizantes", author: "Natalia Villa", date: "2020-02-06", hits: 7094, category: "Productos" },
  { id: 61, title: "Tipos de desinfectantes ideales para cumplir las normas de bioseguridad", author: "Natalia Villa", date: "2020-02-13", hits: 31457, category: "Bioseguridad" },
  { id: 62, title: "Métodos de prevención del Coronavirus ¡No entres en pánico!", author: "Natalia Villa", date: "2020-02-25", hits: 1771, category: "Salud y bienestar" },
  { id: 63, title: "¿Las mascarillas o tapabocas son indispensables para evitar el Coronavirus?", author: "Natalia Villa", date: "2020-03-03", hits: 3825, category: "Salud y bienestar" },
  { id: 64, title: "Lavarse bien las manos salva vidas", author: "Natalia Villa", date: "2020-03-10", hits: 3454, category: "Salud y bienestar" },
  { id: 65, title: "Normatividad sanitaria en Colombia: todo lo que necesitas saber", author: "Natalia Villa", date: "2020-03-20", hits: 22830, category: "Bioseguridad" },
  { id: 66, title: "Lo que debes desinfectar sin falta para un negocio impecable y seguro", author: "Natalia Villa", date: "2020-03-25", hits: 1712, category: "Salud y bienestar" },
  { id: 67, title: "Recomendaciones coronavirus (COVID-19) para copropiedades y conjuntos residenciales", author: "Natalia Villa", date: "2020-03-29", hits: 2336, category: "Salud y bienestar" },
  { id: 68, title: "Lo que debes saber acerca de la inocuidad alimentaria", author: "Natalia Villa", date: "2020-04-02", hits: 2931, category: "Salud y bienestar" },
  { id: 69, title: "Qué alimentos se deben lavar y cuáles no: Guía completa", author: "Natalia Villa", date: "2020-04-09", hits: 37704, category: "Salud y bienestar" },
